...
test("Board 2x2 is able to correctly iterate once", () => {
     ...
     */
    let inputStates = boardInput.iterates().map(cellsRow => cellsRow.map(cell => cell.getStatus()));
    ...
    inputStates = boardInput.iterates().map(cellsRow => cellsRow.map(cell => cell.getStatus()));
...
test("Board 6x6 is able to correctly iterate once", () => {
    ...
    const inputStates = boardInput.iterates().map(cellsRow => cellsRow.map(cell => cell.getStatus()));
